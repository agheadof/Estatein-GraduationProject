...
const FilterProperty = () => {
  ...
  return (
    <SectionWrapper className="mt-0 lg-custom:-mt-12 2xl:-mt-16 py-5 lg:py-0 w-full">
      ...
      >
        <div data-aos="fade-up" className="px-4 py-2 flex justify-between items-center mb-2.5 rounded-lg bg-white99 dark:bg-gray08 text-black dark:text-white focus:outline-none focus:border-purple-500">
          <input
            type="text"
      ...
      >
        <div data-aos="fade-up" className="grid grid-cols-1 lg-custom:grid-cols-5 gap-5">
