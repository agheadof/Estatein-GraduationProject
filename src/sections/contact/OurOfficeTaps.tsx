      ...
      <div className="grid grid-cols-3 bg-white97 dark:bg-gray10 gap-2.5 w-fit p-2.5 rounded-lg 2xl:rounded-xl">
        {tabs.map((tab) => (
          <button
            ...
            className={`w-full py-3.5 px-5 2xl:py-4.5 2xl:px-6 border dark:border-gray15 border-purple70 rounded-lg 2xl:rounded-[10px] capitalize text-sm/[1.5] 2xl:text-lg font-medium text-black dark:text-white ${
