...
const Hero = () => {
    return (
        <div className=" mt-10 flex flex-col-reverse md:flex-row items-center md:gap-[60px] 2xl:gap-[80px] h-screen  text-white   px-4 md:pl-8 lg-custom:pl-20 2xl:pl-[162px]">
            <div className="flex flex-col gap-10 md:gap-[50px] 2xl:gap-[60px] ">
            ...
            <div className="relative  md:h-screen flex items-end border border-gray15 md:border-none  rounded-xl   bg-gray10 bg-[linear-gradient(to_bottom_left,_#2A213F,_#19191900,_#19191900)]">
