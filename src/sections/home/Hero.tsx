...
const Hero = () => {
  ...
  return (
    ...
    <div className="relative mt-[94px] lg-custom:h-[calc(100vh-79px)] lg-custom:mt-[79px]  2xl:h-[calc(100vh-94px)] 2xl:mt-[94px]  flex flex-col-reverse lg-custom:flex-row lg-custom:items-center lg-custom:gap-[60px] 2xl:gap-[80px] text-white">
      ...
      <img
        src="/assets/images/MainHero/main.png"
        alt="Hero"
        className="hidden lg-custom:block  absolute bottom-0 lg-custom:h-[calc(100vh-79px)] w-1/2 right-0"
      />
    </div>
