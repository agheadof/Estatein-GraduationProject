    ...
    <div className="relative h-screen pt-[250px] md:pt-[94px] flex flex-col-reverse lg-custom:flex-row lg-custom:items-center lg-custom:gap-[60px] 2xl:gap-[80px] text-black  dark:text-white">
      ...
      <div className="flex mt-10 lg-custom:w-[48%] flex-col gap-10 lg-custom:gap-[50px] 2xl:gap-[60px] px-4 lg-custom:pl-20 2xl:pl-[162px]">
        ...
        <div className="flex flex-col lg-custom:flex-row gap-4">
          ...
          <Link to="/properties" className="text-center py-3.5 px-5 2xl:py-[18px] 2xl:px-6 text-sm 2xl:text-lg bg-purple90 dark:bg-purple60 rounded-lg">
            Browse Properties
          </Link>
        </div>
      ...
      <div className="relative mx-4 lg-custom:mx-0 lg-custom:px-0 lg-custom:w-[48%] h-full flex items-end border border-white90 dark:border-gray15 lg-custom:border-none rounded-xl lg-custom:rounded-none bg-white97 dark:bg-gray10 bg-[linear-gradient(to_bottom_left,_#2A213F,_#19191900,_#19191900)]">
