...
import { heroBgAos, heroBtnAboutAos, heroBtnBrowseAos, heroCountUpAos, heroDescAos, heroDesktopImgAos, heroH1Aos, heroLeftColAos, heroMobileImgAos, heroRootAos } from "../../utlis/Anamation";
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div {...heroLeftColAos()} className="flex justify-center lg-custom:w-[50%] flex-col gap-10 lg-custom:gap-[4vh] 2xl:gap-[5vh]  px-4 lg-custom:px-0 lg-custom:pl-20 2xl:pl-[162px] ">

        {/* === Title and Description === */}
        <div className="flex flex-col gap-4 lg-custom:gap-5 2xl:gap-6 mt-20 lg-custom:mt-0">
          <h1 {...heroH1Aos()} className="text-[28px] lg-custom:text-[45px] 2xl:text-[60px] font-semibold leading-[120%]">
            {heroContent.title}
          </h1>

          <p {...heroDescAos()} className="text-sm lg-custom:text-base 2xl:text-lh font-medium text-gray40 dark:text-gray60 leading-[150%]">
        ...
        <div className="flex flex-col lg-custom:flex-row gap-4">
          <Link {...heroBtnAboutAos()} to="/about" className="text-center py-3.5 px-5 2xl:py-[18px] text-sm 2xl:text-lg 2xl:px-6 border  border-white90 dark:border-gray15 rounded-lg">
            Learn More
          </Link>
          <Link {...heroBtnBrowseAos()} to="/properties" className="text-center py-3.5 px-5 2xl:py-[18px] 2xl:px-6 text-sm 2xl:text-lg bg-purple90 dark:bg-purple60 rounded-lg hover:bg-purple75">
            Browse Properties
          </Link>
        </div>
