...
//                     <h3 className=" lg-custom:text-xl 2xl:text-2xl text-white font-semibold lg-custom:mb-2.5 2xl:mb-3.5">
//                       {client.title}
//                     </h3>
//                     <p className=" lg-custom:text-base 2xl:text-lg text-white font-medium">
//                       {client.message}
//                     </p>
//                   </div>
...
//                       src={client.image}
//                       alt="image"
//                       className=" w-[50px] 2xl:w-[60px] h-[50px] 2xl:h-[60px] rounded-full object-cover "
//                     />
//                     <div>
//                       <h4 className=" text-white text-lg lg-custom:text-xl 2xl:text-xl font-medium ">
//                         {client.name}
//                       </h4>
//                       <span className=" text-gray60 text-sm lg-custom:text-base 2xl:text-lg font-medium">
//                         {client.location}
//                       </span>
//                     </div>
//                   </div>
...
//             01 <span className=" text-gray60">of 10</span>
//           </p>
//           <div className=" flex gap-2.5">
//             <button
//               ref={prevRef}
//               className=" p-3.5 bg-gray10 border border-gray15 rounded-full"
//             >
