    ...
    return (
      <SectionWrapper className="pt-20 lg-custom:pt-[120px] 2xl:pt-[150px]">
        <section className="relative ">
          ...
          <button
            className="text-white absolute left-[50%] -translate-x-[50%] bottom-[0px] text-sm underline cursor-pointer"
            onClick={() => setShowReviewModal(true)}
          >
            Add a review
          </button>
          {showReviewModal && <ReviewModal closeModal={handleCloseModal} />}
        </section>
      </SectionWrapper>
    );
}
