...
import { GenericSliderMotionConfig, SwiperSlideMotionConfig } from '../../../utlis/Anamation'
...
const GenericSlider = <T,>({
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="flex justify-between items-center pt-4 2xl:pt-5 border-t border-t-white90 dark:border-t-gray15"
