...
import { defaultMotionConfig, fadeLeft, fadeRight, fadeUp } from "../../../utlis/Anamation"
        ...
        <footer className=" bg-purple97 dark:bg-gray10 text-black dark:text-white ">
            <div className="huge:max-w-[1920px] huge:mx-auto px-4 md:px-8 lg-custom:!px-[120px] 2xl:!px-[162px]">
                <div className=" pt-[50px] pb-5 md:pt-20 md:pb-3 2xl:pb-[16px] 2xl:pt-[100px]">
                    <motion.div className="flex flex-col lg-custom:flex-row justify-between gap-[50px] lg-custom:gap-5"
                        variants={fadeUp}            {...defaultMotionConfig}

                    >
                        <motion.div className="flex flex-col gap-5 lg-custom:gap-6 2xl:gap-[30px]" variants={fadeUp}
                            {...defaultMotionConfig}>
                            <img src={logo} alt="logo" className=" w-28 h-8 2xl:w-40 2xl:h-12" />
                            <FooterNewsletter />
                        </motion.div>
                        <motion.div className="grid grid-cols-2 lg-custom:grid-cols-5  gap-5 lg-custom:gap-[10px] 2xl:gap-[100px]" variants={fadeRight}
                            {...defaultMotionConfig}>
                    ...
                    <motion.div className="mt-10 border-t border-gray30 pt-8" variants={fadeUp} {...defaultMotionConfig}>

                        <div className="flex flex-col-reverse gap-[20px] lg-custom:flex-row justify-between items-center">
                            <motion.div className="flex justify-center items-center flex-wrap gap-[10px] md:gap-[38px] text-black dark:text-white font-medium lg-custom:text-sm 2xl:text-[18px] leading-6"
                                variants={fadeLeft}
                                {...defaultMotionConfig}>
                                <p>{footerNote}</p>
                            ...
                            <motion.div
                                className="flex space-x-4 mt-4 lg:mt-0" variants={fadeRight}
                                {...defaultMotionConfig}>
