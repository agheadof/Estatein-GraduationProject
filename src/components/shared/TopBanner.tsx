...
const TopBanner = ({ isVisible, onClose }: TopBannerProps) => {
  return (
    <div
      className={`relative flex justify-start md:justify-center border-b border-gray15 bg-gray10 pt-10 pb-5 px-4 md:py-3.5 2xl:py-[18px] 2xl:px-8 bg-[url("/assets/images/TopBanner/AbstractDesign.png")] bg-no-repeat bg-cover 
