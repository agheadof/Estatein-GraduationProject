...
//   >
//     <img
//       src="/images/chatbot/chatIconw.svg"
//       alt="Chat Icon"
//       className="w-[14px] transition-transform duration-300 group-hover:-translate-y-[200%]"
//     />
//     <span className="absolute text-white text-[0px] group-hover:text-[13px] group-hover:bottom-auto transition-all duration-300">
//       {chatbotTexts.headerTitle}
//     </span>
//   </button>
// </div>
...
//               >
//                 {loading ? (
//                   <img src="/images/chatbot/stop.svg" alt="Stop" className="w-5 h-5" />
//                 ) : (
//                   <img src="/images/chatbot/send.svg" alt="Send" className="w-5 h-5" />
//                 )}
//               </button>
//             </div>
//           </motion.div>
