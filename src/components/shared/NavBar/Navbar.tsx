...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray10 text-white py-5 px-4 lg-custom:px-10 fixed w-full z-50 border-b-2  border-b-gray15">
      <SectionWrapper>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.ul initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}
              className="flex flex-col gap-4 mt-4 lg-custom:hidden bg-gray08 p-5 rounded-lg border border-gray15 ">
