      ...
      {!property.loading && !property.error && property.current && (
        <div className="flex flex-wrap md:flex-nowrap gap-10 md:gap-5 lg-custom:gap-10 border-t border-t-gray15 pt-4 justify-between">
          <div className="flex flex-col gap-1.5 lg-custom:gap-2 2xl:gap-2.5">
            ...
            <span className="text-gray60 dark:text-white font-semibold leading-[150%] text-lg lg-custom:text-xl 2xl:text-2xl">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-1.5 lg-custom:gap-2 2xl:gap-2.5">
              ...
              <span className="text-gray60 dark:text-white font-semibold leading-[150%] text-lg lg-custom:text-xl 2xl:text-lg">
                {castingToNumber(property.current.details[1].label)}
              </span>
            </div>
          </div>

          <div className="flex gap-4 w-full md:w-auto border-t border-t-gray15 pt-4 md:border-0 md:pt-0">
