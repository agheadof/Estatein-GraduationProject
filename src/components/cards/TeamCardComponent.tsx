        ...
        <div className="flex flex-col gap-10 lg-custom:gap-[50px] p-5 lg-custom:p-6 2xl:p-[30px] border border-gray15 rounded-xl ">
            ...
            <div className="flex flex-col gap-4 lg-custom:gap-5 2xl:gap-6 ">
                <div className="text-center flex flex-col gap-0.5 lg-custom:gap-1 2xl:gap-1.5 ">
                    <h3 className="text-lg lg-custom:text-[20px] 2xl:text-2xl font-semibold leading-7 text-black dark:text-white">{name}</h3>
                    <p className="text-sm lg-custom:text-base 2xl:text-lg font-medium text-gray40 dark:text-gray60">{role}</p>
                </div>
                ...
                <div className="relative w-full ">
                    ...
                    />
                    <button className="bg-purple90 dark:bg-purple60 absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center justify-center p-3.5 lg-custom:p-2 2xl:p-2.5 rounded-full cursor-pointer">
