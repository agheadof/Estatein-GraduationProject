...
function PropertiesCard({ property }: Props) {
    ...
    return (
        <>
            <div className="  p-6 lg-custom:p-[30px] 2xl:p-[40px] border border-gray15 rounded-xl ">
                ...
                <div className=" mb-5 lg-custom:mb-6 2xl:mb-[30px] ">
                    <h2 className=" line-clamp-1 text-lg lg-custom:text-xl 2xl:text-2xl font-semibold text-white mb-0.5 lg-custom:mb-1 2xl:mb-1.5 ">
                        {property.title}
                    </h2>
                    <p className=" line-clamp-2 text-sm lg-custom:text-base 2xl:text-lg text-gray60 font-medium ">
