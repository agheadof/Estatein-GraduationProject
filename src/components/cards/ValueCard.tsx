...
const ValueCard = ({
  ...
  return (
    <div
      className={`bg-white99 dark:bg-gray08 flex flex-col justify-center gap-3.5 lg-custom:gap-4 2xl:gap-5 ${cardStyle}`}
    >
      {children}
      <div className={`flex gap-2.5 md:gap-4 2xl:gap-5 items-center  ${titleStyle}`}>
        <img
          className="border border-purple90 dark:border-purple60 p-3.5 2xl:p-5 lg-custom:p-4 rounded-full "
          src={cardImg}
          alt="card image"
        />
