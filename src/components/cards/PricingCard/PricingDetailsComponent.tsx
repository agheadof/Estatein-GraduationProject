...
const PricingDetailsComponent = ({
  ...
  return (
    ...
    >
      <h5 className="text-sm md:text-lg text-gray60 font-medium">{title}</h5>
      <div className="flex items-center gap-3 md:gap-4">
        <span className="text-lg md:text-xl 2xl:text-2xl text-white font-semibold">
          {price}
        </span>
        {desc && (
          <p
            className={`text-sm 2xl:text-lg text-gray60 bg-gray10 border border-gray15 py-1.5 px-3 2xl:py-2 2xl:px-3 ${
              borderRadius
                ? "rounded-[28px]"
