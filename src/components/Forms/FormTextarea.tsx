  ...
  return (
    <div className={`${className} flex flex-col col-span-2`}>
      ...
      <textarea
        ...
        value={value}
        onChange={onChange}
        className="rounded-lg dark:bg-gray10 bg-purple95 dark:text-gray40 text-purple65 2xl:text-lg lg-custom:text-sm/[20px] font-medium border-1 dark:border-gray15 border-purple70 px-5 py-6 2xl:h-42.5 lg-custom:h-30.5 h-22.5"
      />
